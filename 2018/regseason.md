...
<table class="display">
  <caption style="text-align: center;"> <b>PF</b> = Points For, <b>PA</b> = Points Against, <b>+/-</b> = Point Differential<br><b>Tiebreakers</b>: 1.  Head to Head Record  2. Point Differential </caption>
  <colgroup>
          <col class="twenty"/>
          <col class="twenty"/>
          <col class="ten"/>
  ...
  <tbody>
   ...
   {% assign pf = 0 %}
   {% assign pa = 0 %}
   {% for game_hash in site.data.seasons.eighteen.games %}

...
datatable: true
---
{% assign game = site.data.seasons.eighteen.games[page.gamenum] %}
{% assign home = site.data.seasons.eighteen.teams[game.home_team_name] %}
{% assign away = site.data.seasons.eighteen.teams[game.away_team_name] %}
...
{% if game.stage == "reg" %}
<p> In this season, regular season games were played first to 15, with scoring being 1s/2s.</p>
<h2> {{home.name}} ({{home.wins}}-{{home.losses}})</h2>
{% else %}
In this season, playoff games were played first to 17, with scoring being 1s/2s.</p>
...
{% endif %}
<table class="display">
  <caption style="text-align: center;"> <b>PTS</b> = Points Scored, <B>SHO</B> = Shots, <b>REB</b> = Rebounds, <b>AST</b> = Assists, <b>STL</b> = Steals, <b>BLK</b> = Blocks </caption>
  <colgroup>
      <col class="fifteen"/>
      <col class="nine"/>
      <col class="nine"/>
